...
const FilterHeader = () => {
  ...
  return (
    <header>
      <div className="w-[1200px] flex items-center justify-between py-6 px-[72px] m-auto">
        <FilterFlightsDrawer>
          <div className="flex p-3 border-2 items-center justify-between rounded-[32px] gap-4 tracking-wider">
            ...
            <div className="w-9 h-9 rounded-full p-0 bg-button-secondary flex justify-center items-center">
              <Image
                src={searchIcon}
                width={16}
                height={16}
